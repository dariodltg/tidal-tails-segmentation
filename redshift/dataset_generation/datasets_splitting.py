...
paths_images_train = ["../segmentation_training/v5/galaxies_train_VIS/", "../segmentation_training/v5/galaxies_train_NISP_H/","../segmentation_training/v5/galaxies_train_NISP_J/","../segmentation_training/v5/galaxies_train_NISP_Y/"]

paths_images_test = ["../segmentation_training/v5/galaxies_test_VIS/", "../segmentation_training/v5/galaxies_test_NISP_H/","../segmentation_training/v5/galaxies_test_NISP_J/","../segmentation_training/v5/galaxies_test_NISP_Y/"]
