...
# %%
hiperparametros = {'nombre_notebook': 'Training_NISP_J_1000imgs_v2.ipynb',
                    'nombre_experimento' : 'Training_NISP_J_1000imgs_v2',
                    'nombre_mejor_modelo_a_guardar' : 'NISP_J_1000imgs_v2',
                    'device' : torch.device("cuda:0" if torch.cuda.is_available() else "cpu"),
                    'ruta_galaxias' : 'galaxies_train_NISP_J/galaxy_and_stream_convolved*',
                    'ruta_mascaras' : 'masks_NISP_J/mask_',
                    'ruta_galaxias_test' : 'galaxies_test_NISP_J/galaxy_and_stream_convolved*.fits',
                    'ruta_mascaras_test' : 'masks_NISP_J/mask_',
