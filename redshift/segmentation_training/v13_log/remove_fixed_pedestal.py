...
if __name__ == "__main__":
    ...
    input_folders = [
        'galaxies_train_VIS_with_pedestal',
        'galaxies_train_NISP_H_with_pedestal',
        'galaxies_train_NISP_J_with_pedestal',
        'galaxies_train_NISP_Y_with_pedestal'
    ]
    
    # Define your 4 output folders
    output_folders = [
        'galaxies_train_VIS',
        'galaxies_train_NISP_H',
        'galaxies_train_NISP_J',
        'galaxies_train_NISP_Y'
    ]
