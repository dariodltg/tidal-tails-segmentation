...
def main():
    ...
    directory_pairs = [
        ("../real_tidal_tails_crops_with_pedestal/VIS", 
         "../real_tidal_tails_crops_segmented_sextractor/VIS"),
        ("../real_tidal_tails_crops_with_pedestal/NISP_H", 
         "../real_tidal_tails_crops_segmented_sextractor/NISP_H"),
        ("../real_tidal_tails_crops_with_pedestal/NISP_J", 
         "../real_tidal_tails_crops_segmented_sextractor/NISP_J"),
        ("../real_tidal_tails_crops_with_pedestal/NISP_Y", 
         "../real_tidal_tails_crops_segmented_sextractor/NISP_Y"),
