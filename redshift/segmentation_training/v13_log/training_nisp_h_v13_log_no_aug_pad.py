...
# %%
hiperparametros = {'nombre_notebook': 'Training_NISP_H_1000imgs_v13_log.ipynb',
                    'nombre_experimento' : 'Training_NISP_H_1000imgs_v13_log_no_aug_pad',
                    'nombre_mejor_modelo_a_guardar' : 'NISP_H_1000imgs_v13_log_no_aug_pad',
...
class MyDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        print(self.galaxias_con_colas_de_marea[index])
...
input_item, label_item = train_dataset.__getitem__(6)
