...
# %%
hiperparametros = {'nombre_notebook': 'Training_NISP_J_1000imgs_v6_linear.ipynb',
                    'nombre_experimento' : 'Training_NISP_J_1000imgs_v6_linear',
                    'nombre_mejor_modelo_a_guardar' : 'NISP_J_1000imgs_v6_linear',
...
summary(unet, (1, hiperparametros['ancho_imagen_deseado'], hiperparametros['alto_imagen_deseado']))

# %%
#Comprobamos que hemos construido la arquitectura de la red correctamente cargando una imagen del dataset
input_item, label_item = train_dataset.__getitem__(5)
